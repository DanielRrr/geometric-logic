...
\centerline{
\xymatrix{
M A_1 \times \dots \times M A_n \ar[rr]^{M f} \ar[d]_{h_{A_1} \times \dots \times h_{A_n}} && M B \ar[d]^{h_B} && M R \ar[d]_{h_R} \:\: \ar@{^{(}->}[rr] && M A_1 \times \dots \times M A_n \ar[d]^{h_{A_1} \times \dots \times h_{A_n}} \\
N A_1 \times \dots \times N A_n \ar[rr]_{N f} && N B && N R \:\: \ar@{^{(}->}[rr] && N A_1 \times \dots \times N A_n
}
}
...
\centerline{
\xymatrix{
M A_1 \times \dots \times M A_n \ar[rrr]^{([[\vec{x}. t_1]], \dots, [[\vec{x}. t_m]])} &&& M C_1 \times \dots \times M C_m \ar[rrr]^f &&& M B
}
}
\end{enumerate}
...
\centerline{
\xymatrix{
[[\vec{x}.\varphi]] \ar[rrr] \ar[d] &&& M R \ar[d] \\
M A_1 \times \dots \times M A_n \ar[rrr]_{([[\vec{x}.t_1]]_M, \dots, [[\vec{x}.t_m]]_M)} &&& M B_1 \times \dots \times M B_m
}}
...
\centerline{
\xymatrix{
[[\vec{x}. \varphi]]_M \ar[rr]^e && M A_1 \times \dots \times M A_n \ar@<1ex>[rrr]^{[[\vec{x}.s]]_M} \ar@<-1ex>[rrr]_{[[\vec{x}.t]]_M} &&& M B
}
}
...
\centerline{
\xymatrix{
[[\vec{x}. \psi \land \theta]]_M \ar[rr] \ar[d] && [[\vec{x}. \theta]]_M \ar[d] \\
[[\vec{x}. \psi]] \ar[rr]_M && M A_1 \times \dots \times M A_n
}
}
...
\centerline{
\xymatrix{
[[\vec{x}, y. \psi]]_M \ar[rr] && M A_1 \times \dots \times M A_n \times M B \ar[rr]^{\pi} && M A_1 \times \dots \times M A_n
}
}
